...
graph LR
	...
	subgraph three
      A31[Driver] -- Link text --> B31(Metastore)
      A32[Driver] -- Link text --> B32(Metastore)
      B31(Metastore) -- Link text --> C3((MySql))
      B32(Metastore) -- Link text --> C3((MySql))
    end
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbOTYwMzAyMDE3LC00NjYzMzIyNTMsLTE1OT
